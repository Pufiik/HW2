...
class GifAdapter(val items: List<Image>): RecyclerView.Adapter<GifAdapter.GifViewHolder>() {
    ...
    override fun onBindViewHolder(holder: GifViewHolder, position: Int) = holder.bind(items[position])
